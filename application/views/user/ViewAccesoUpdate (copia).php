                ...
                <div class="form-inline">
                    <div class="form-group col-xs-12">
                        ...
                        <select name="id_user" id='id_user' class="form-control" style="width:90%" multiple='multiple'>
                            <option value=''>Seleccione</option>
                            <?php
                            foreach ($auth_user as $row) {
                                foreach (explode('-', $detalles->id_user) as $value) {
                                    if($row->id == $value){
                                    ?>
                                        <option value="<?= $row->id; ?>" selected="selected"><?= $row->username; ?></option>
                                    <?php
                                    }
                                }
                            }
                        ...
                        <input id='user_ids' type='hidden' name='user_ids' value="<?=$detalles->id_user?>"/>
