...
<form id='form_observacion_acciones' action="" method="POST">
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-10">
                        <div style="float: left;">
                            <input disabled="" placeholder="00-00-00-00" value="<?php echo $detalles_lista->estructura; ?>" type="text" id="estructura_id" name="estructura" placeholder="0000" class="form-control" style='width: 90%;'/>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <div class="col-xs-10">
                        <textarea id="observaciones" disabled="" name="observaciones" placeholder="Ingrese las Observaciones" class="form-control" style='width: 65%;text-transform:uppercase' onblur="javascript:this.value = this.value.toUpperCase();"><?php echo $detalles_lista->observaciones; ?></textarea>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($imp_presupuestaria as $value) {
                            ...
                            <tr style="font-size: 16px" id="tr_<?= $value->pk ?>">
                                ...
                                <td><input readonly type="text" style="width:130px;" class="capturar_item form-control" id="m_asig_<?php echo $value->pk; ?>" name="<?php echo $value->pk; ?>" value="<?php echo $value->m_asig; ?>"/></td>
                            </tr>
                            <?php
                            $i = $i + 1;
                        }
        ...
        <div class="row" style="text-align: center">
            ...
            <?php if ($preliminar != 1) { ?>
            <input type="hidden" id="registrar" style="font-weight: bold;font-size: 13px" class="btn btn-success" value="Guardar cambios"/>
