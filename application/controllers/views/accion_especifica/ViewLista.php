            ...
            <tbody>
                ...
                foreach ($lista_accion_especifica as $value) {
                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td>
                            <a href="<?php echo base_url('accion_especifica/ControllersAccionEspecifica/procesar/' . $value->id ."?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                                <?php echo $value->accion_especifica; ?>
                            </a>
                        </td> 
