    ...
    $(document).ready(function () {
        ...
        $("#registrar").click(function (e) {
            ...
            if ($('#codigo').val().trim() == '') {
                ...
                $.post('<?php echo base_url(); ?>sectores/ControllersSectores/procesar_data/2', $('#form_sectores').serialize(), function (response) {
...
<form id="form_sectores" action="" method="POST">
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-4">
                <input id="sector" value="<?php echo $detalles_lista->sector ?>" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el sector" name="sector" type="text" class="form-control" />
