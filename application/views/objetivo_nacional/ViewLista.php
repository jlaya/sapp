            ...
            bootbox.dialog({
                ...
                buttons: {
                    ...
                    danger: {
                        ...
                        callback: function () {
                            //alert(id)
                            $.post('<?php echo base_url(); ?>objetivo_nacional/ControllersObjN/delete/' + id + '', function (response) {
...
<div class="row-fluid" >
    <div class="container mainbody-section text-center"  style="width:100%;">
        <a href="<?php echo base_url('objetivo_nacional/ControllersObjN/nuevo'); ?>">
        ...
        <table style="width:100%;" border="0" align="center" cellspacing="1" id="tab_obj_N" align="center"
            ...
            <thead style="font-size: 16px">
                <tr style="background-color: #263238">
                    <th style='text-align: center;color: white' colspan="15">Listado de Objetivos Nacionales</th>
                </tr>
                <tr style="background-color: #8BA8A7">
                    ...
                    <th style='text-align: center'>Objetivos Nacionales</th>
            ...
            <tbody>
                ...
                <?php
                $i = 1;
                foreach ($lista_objetivo_nacional as $value) {
                    ?>
                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td><?php echo $i; ?></td>
                        <td>
                            <a href="<?php echo base_url('objetivo_nacional/ControllersObjN/procesar/' . $value->id. "?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                            <?php
                        ...
                        <td><?php echo $value->objetivo_nacional; ?></td>
                        <td style='text-align: center'>
                            <a href="<?php echo base_url('objetivo_nacional/ControllersObjN/procesar/' . $value->id); ?>">
