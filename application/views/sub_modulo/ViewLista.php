...
<script>
    $(document).ready(function () {
        ...
        var TSModulo = $('#tab_sub_modulo').dataTable({
            "iDisplayLength": 10,
            "iDisplayStart": 0,
        ...
        $("table#tab_sub_modulo").on('click', 'img.borrar', function (e) {
            e.preventDefault();
            ...
            bootbox.dialog({
                ...
                buttons: {
                    ...
                    danger: {
                        ...
                        callback: function () {
                            //alert(id)
                            $.post('<?php echo base_url(); ?>sub_modulo/ControllersSubModulo/delete/' + id + '', function (response) {
...
<div class="row-fluid" >
    <div class="container mainbody-section text-center"  style="width:100%;">
        <a href="<?php echo base_url('sub_modulo/ControllersSubModulo/nuevo'); ?>">
        ...
        <table style="width:100%;" border="0" align="center" cellspacing="1" id="tab_sub_modulo" align="center"
            ...
            <thead style="font-size: 16px">
                <tr style="background-color: #263238">
                    <th style='text-align: center;color: white' colspan="15">Listado de Sub Módulos</th>
                </tr>
                <tr style="background-color: #8BA8A7">
                    <th></th>
                    <th style='text-align: center'>Item</th>
                    <th style='text-align: center'>Módulo</th>
                    <th style='text-align: center'>Sub Módulo</th>
                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td>
                            ...
                            foreach ($lista_modulo as $modulo) {
                                if ($modulo->id == $value->id_modulo) {
                                    echo $modulo->modulo;
                                }
                            }
                            ?>
                        </td>
                        <td><?php echo $value->sub_modulo; ?></td>
                        ...
                        <td style='text-align: center'>
                            <a href="<?php echo base_url('sub_modulo/ControllersSubModulo/procesar/' . $value->id); ?>">
