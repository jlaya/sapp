...
<div class="row">
    <form id="frm" method="POST">
        ...
        <input type="hidden" id="acc" name="acc" value='<?php echo $acc;?>' />
        ...
        <div class="col-xs-8">
            ...
            <div class="col-xs-2">
				<label for='compromiso'>Causado</label>
                <input style="text-align: right; width: 120%;height: 31px;" class="form-control" type="text" id="compromiso" name="compromiso" />
            </div>
            <div class="col-xs-2">
                <input type="submit" value="Guardar" class="btn btn-primary guardar" style="margin-left: 20%;margin-top: 12%;">
            </div>
        </div>
            ...
            <legend>EJECUCIÓN FINANCIERA</legend>
                ...
                <thead>
                    <tr style="width: 963.75px !important;">
                        ...
                        <th>Monto</th>
                        <th style='width:5% !important; text-align: right;' hidden="">Acción</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach ($obj as $key => $value) { ?>
                        <tr data-id="<?php echo $value->id;?>" data-partida="<?php echo $value->partida_id;?>" data-monto="<?php echo number_format($value->compromiso, 2, ",", ".");?>">
                            <td>
    ...
    $(document).ready(function () {
        ...
        $("input.guardar").click(function (e) {
            ...
            if ($('#partida_id').val() == 0) {
                ...
                $.post('<?php echo base_url(); ?>gestion/GestionControllers/save', $('#frm').serialize(), function (response) {
        ...
        $('.table-gestion-financiera tbody').on('click', 'span.delete-row', function () {
            ...
            var $url = base_url("/acciones/registro/ControllersRegistro/deleteActionFAcc");
            var $id   = $(this).closest('tr').data('id');
