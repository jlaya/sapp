            ...
            bootbox.dialog({
                ...
                buttons: {
                    ...
                    danger: {
                        ...
                        callback: function () {
                            //alert(id)
                            $.post('<?php echo base_url(); ?>objetivo_estrategico/ControllersObjE/delete/' + id + '', function (response) {
...
<div class="row-fluid" >
    <div class="container mainbody-section text-center"  style="width:100%;">
        <a href="<?php echo base_url('objetivo_estrategico/ControllersObjE/nuevo'); ?>">
        ...
        <table style="width:100%;" border="0" align="center" cellspacing="1" id="tab_obj_N" align="center"
            ...
            <thead style="font-size: 16px">
                <tr style="background-color: #263238">
                    <th style='text-align: center;color: white' colspan="15">Listado de Objetivos Estratégicos</th>
                </tr>
            ...
            <tbody>
                ...
                <?php
                $i = 1;
                foreach ($lista_objetivo_estrategico as $value) {
                    ?>
                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td><?php echo $i; ?></td>
                        <td>
                            <a href="<?php echo base_url('objetivo_estrategico/ControllersObjE/procesar/' . $value->id. "?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                            <?php
                        ...
                        <td><?php echo $value->objetivo_estrategico;?></td>
                        <td style='text-align: center'>
                            <a href="<?php echo base_url('objetivo_estrategico/ControllersObjE/procesar/' . $value->id); ?>">
