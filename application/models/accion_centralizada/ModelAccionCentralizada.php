 ...
 * @author jesus
 */
class ModelAccionCentralizada extends CI_Model
{
    ...
    {
        $result = $this->db->where('accion_centralizada =', $datos['accion_centralizada']);
        ...
        if ($result->num_rows() > 0) {
            ...
            $result = $this->db->insert("accion_centralizada", $datos);
            return $result;
        }
    }
    ...
    public function actualizar($datos)
    {
        ...
        $result = $this->db->update('accion_centralizada', $datos);
        return $result;
    }
    ...
    public function eliminar($id)
    {
        ...
        if ($result->num_rows() > 0) {
            ...
            $result = $this->db->delete('accion_centralizada');
            return $result;
        /*}*/
    }
