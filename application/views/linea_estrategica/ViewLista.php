            ...
            <tbody>
                ...
                foreach ($lista_linea_estrategica as $value) {
                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td>
                            <a href="<?php echo base_url('linea_estrategica/ControllersLineaE/procesar/' . $value->id. "?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                                <?php echo $value->linea_estrategica; ?>
                            </a>
                        </td> 
