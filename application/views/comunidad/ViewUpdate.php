...
<form id='form_modulo' action="" method="POST">
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-10">
                <input id="modulo" autofocus="" value="<?php echo $detalles_lista->modulo ?>" style="width: 100%;" placeholder="Ingrese el nombre del módulo" name="modulo" type="text" class="form-control" />
            </div>
        </div>
        <div class="panel-body">
            <div class="col-xs-2" >Url</div>
            <div class="col-xs-10">
                <input id="url" readonly='readonly' value="<?php echo $detalles_lista->url ?>" style="width: 100%;"  placeholder="Ingrese la url" name="url" type="text" class="form-control" />
            </div>
        </div>
        <div class="panel-body">
            ...
            <div class="col-xs-2" style='margin-left: -37%'>
                ...
                <?php if($detalles_lista->desplegable == 't'){
                  ?>
                  checked='checked'
                 <?php }?>/>
            </div>
