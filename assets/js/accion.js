$(document).ready(function () {
    ...
    var table = $('.table-gestion-financiera').DataTable({
        ...
        var $url = base_url("/acciones/registro/ControllersRegistro/search");
        var $url_e = base_url("/acciones/registro/ControllersRegistro/list_estructura");
        ...
        $.buscar($url, {id: value, acc: 1}, function (data, textStatus, xhr) {
            ...
            $.each(data.financiero_acc, function (i, o) {
                ...
                table.row.add([partida, "<span style='text-align: right'>"+o.compromiso+"</span>", add_row+"&nbsp;"+remove_row]).draw(false)
        ...
        $('.table-gestion-financiera tbody').on('click', 'span.add-row', function () {
            ...
            var last_id = $.search_id("/acciones/registro/ControllersRegistro/last_id", "ejecucion_financiera_acc");
            ...
            if (bandera == true) {
                $.post(base_url('/acciones/registro/ControllersRegistro/updateActionFAcc'), datos, function (response) {
                    new PNotify({
    ...
    /*$.extend({
        last_id: function (url, table, callbackFnk) {
            $.get(url, {'table':table}, function (data) {
                if (typeof callbackFnk == 'function') {
                    callbackFnk.call(this, data);
                }
            });
