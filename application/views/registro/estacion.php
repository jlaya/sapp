<div class="title_left">
    <h3>Estaciones Policiales</h3>
</div>
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Registro de Estaciones Policiales</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <br />
                <?php
                $attributes = array('id' => 'frmestacion');
                echo form_open('registro/estacion/guardar', $attributes);
                ?>
                <?php echo form_hidden('token', $token) ?>
                <input type="hidden" name="id" value="<?php echo $id?>" id="id">
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-6 ">
                        <label for="estacion">Estación Policial *</label>
                        <input id="estacion" name="estacion" class="form-control" type="text" >
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-6 ">
                        ...
                        <table id="tblticket" class="tabla table table-striped table-bordered dt-responsive nowrap jambo_table bulk_action">
                            <thead>
                                <tr>
                                    ...
                                    <th class="column-title">estacion</th>
    ...
    <script src="<?php echo assets_url('script/estacion.js'); ?>" type="text/javascript" charset="utf-8" ></script>
