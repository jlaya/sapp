            ...
            <tbody>
                ...
                foreach ($lista_objetivo_especifico as $value) {
                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td><?php echo $i; ?></td>
                        <td>
                            <a href="<?php echo base_url('objetivo_especifico/ControllersObjE/procesar/' . $value->id. "?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                            <?php
