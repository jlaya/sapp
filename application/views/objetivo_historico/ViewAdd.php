    ...
    $(document).ready(function () {
        ...
        $("#registrar").click(function (e) {
            ...
            if ($('#plan_patria').val().trim() == '') {
                ...
                $.post('<?php echo base_url(); ?>objetivo_historico/ControllersObjH/guardar', $('#form_objetivo_historico').serialize(), function (response) {
...
<form id='form_objetivo_historico' action="" method="POST">
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-9">
                <textarea id="objetivo_historico" rows='5' style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el Objetivo Histórico" name="objetivo_historico" type="text" class="form-control"></textarea>
            </div>
        </div>
