...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#id_user").change(function () {
            $("#user_ids").val(String($("#id_user").val()).substring(1));
        });
            ...
            <div class="panel-body">
                ...
                <div class="form-inline">
                    <div class="form-group col-xs-12">
                        ...
                        <input id='user_ids' type='hidden' name='user_ids'/>
                    </div>
                </div>
                <br/><br/><br/>
                <br/>
                ...
                <div class="form-inline">
                    <div class="form-group col-xs-12">
                        ...
                        ?>
                        <input type='hidden' id='modulo_ids' name='modulo_ids'/>
                    </div>
                </div>
                <br/><br/>
                <fieldset>
                ...
                <input type='hidden' id='sub_modulo_ids' name='sub_modulo_ids'/>
                <div class="form-inline">
                    <br>
                    <fieldset>
