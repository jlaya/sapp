    ...
    $(document).ready(function () {
        ...
        $("#registrar").click(function (e) {
            ...
            if ($('#codigo').val().trim() == '') {
                ...
                $.post('<?php echo base_url(); ?>plan_patria/ControllersPlanPatria/modificar', $('#form_plan_patria').serialize(), function (response) {
    ...
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default">
        <div class="panel-heading" style='background: linear-gradient(#2F9292, #3B7272);color:#FFFFFF;' >
            <label style="float: left" class="panel-title " ><a href="<?php echo base_url();?>plan_patria/ControllersPlanPatria" >Configuraciones</a>
                > Modificar Plan de la Patria</label>
            <br>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-4">
                <input id="plan_patria" value="<?php echo $detalles_lista->plan_patria ?>" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el plan_patria" name="plan_patria" type="text" class="form-control" />
