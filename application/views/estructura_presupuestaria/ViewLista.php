...
<script>
    $(document).ready(function () {
        ...
        var TEstructura = $('#tab_estructura').dataTable({
            "iDisplayLength": 10,
            "iDisplayStart": 0,
        ...
        $("table#tab_estructura").on('click', 'img.borrar', function (e) {
            e.preventDefault();
            ...
            bootbox.dialog({
                ...
                buttons: {
                    ...
                    danger: {
                        ...
                        callback: function () {
                            //alert(id)
                            $.post('<?php echo base_url(); ?>estructura/CEstructuraPresupuestaria/delete/' + id + '', function (response) {
                                ...
                                if (response == "existe") {
                                    ...
                                    bootbox.alert("Se elimino con exito", function () {
                                        ...
                                        url = '<?php echo base_url(); ?>estructura/CEstructuraPresupuestaria'
                                        window.location = url
                                    });
                                }
...
<div class="row-fluid" >
    <div class="container mainbody-section text-center"  style="width:100%;">
        <a href="<?php echo base_url('estructura/CEstructuraPresupuestaria/nuevo'); ?>">
            <button role="button" class="btn btn-default" style="font-weight: bold;font-size: 13px" id="enviar" >
                &nbsp;<span class="glyphicon glyphicon-plus"></span>&nbsp;
                Agregar Tipo de Estructura Presupuestaria
            </button>
        </a>
        </br>
        </br>
        <table style="width:100%;" border="0" align="center" cellspacing="1" id="tab_estructura" align="center"
            ...
            <thead style="font-size: 16px">
                <tr style="background-color: #263238">
                    <th style='text-align: center;color: white' colspan="15">Listado de Tipo de Estructura</th>
                </tr>
            ...
            <tbody>
                ...
                <?php
                $i = 1;
                foreach ($lista_estructura as $value) {
                    ?>

                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        <td></td>
                        <td><?php echo $i; ?></td>
                        <td><?php echo $value->estructura; ?></td>
                        <td>
                            <a href="<?php echo base_url('estructura/CEstructuraPresupuestaria/procesar/' . $value->id. "?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                                <?php echo $value->descripcion; ?>
                            </a>
                        </td> 
                        <td style='text-align: center'>
                            <a href="<?php echo base_url('estructura/CEstructuraPresupuestaria/procesar/' . $value->id); ?>">
