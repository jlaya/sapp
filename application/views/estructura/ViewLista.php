            ...
            bootbox.dialog({
                ...
                buttons: {
                    ...
                    danger: {
                        ...
                        callback: function () {
                            //alert(id)
                            $.post('<?php echo base_url(); ?>estructura/ControllersEstructura/delete/' + id + '', function (response) {
            ...
            <tbody>
                ...
                foreach ($lista_estructura as $value) {
                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td>
                            <a href="<?php echo base_url('estructura/ControllersEstructura/procesar/' . $value->id. "?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                                <?php echo $value->estructura; ?>
                            </a>
                        </td> 
                        <td style='text-align: center'>
                            <a href="<?php echo base_url('estructura/ControllersEstructura/procesar/' . $value->id); ?>">
