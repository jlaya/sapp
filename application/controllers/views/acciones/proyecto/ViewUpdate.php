...
<form id='form_registro_proyecto' action="" method="POST">
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default">
                    ...
                    <table style="width:100%;background-color: #FFFFFF;" border="0" align="center" cellspacing="1" id="tabla_acciones_especificas" align="center"
                        ...
                        <tbody style="background-color: #FFFFFF;">
                            ...
                            foreach ($distribucion_acc as $value) {
                                ?>
                                <tr style="font-size: 16px;font-size: 8px;" id="tr_<?php echo $value->id; ?>">
                                    <td></td>
                                    <td style='text-align: left;width: 50%'>
                                        <textarea readonly="" rows='10' style="height: 70px;width: 100%;text-transform:uppercase" class="form-control capturar" id='acc_esp_<?= $value->id ?>' name='<?= $value->id ?>' onblur="javascript:this.value = this.value.toUpperCase();"><?php echo $value->acc_esp; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea readonly="" rows='10' style="height: 70px;text-transform:uppercase" class="form-control capturar" id='unidad_medida_<?= $value->id ?>' name='<?= $value->id ?>' onblur="javascript:this.value = this.value.toUpperCase();"><?php echo $value->unidad_medida; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea readonly="" rows='10' style="height: 70px;text-transform:uppercase" class="form-control capturar" id='medio_verificacion_<?= $value->id ?>' name='<?= $value->id ?>' onblur="javascript:this.value = this.value.toUpperCase();"><?php echo $value->medio_verificacion; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea readonly="" rows='10' style="height: 38px;width: 120px;" class="form-control capturar numeric" id='trimestre_i_<?= $value->id ?>' name='<?= $value->id ?>'><?php echo $value->trimestre_i; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea readonly="" rows='10' style="height: 38px;width: 120px;" class=" form-control capturar numeric" id='trimestre_ii_<?= $value->id ?>' name='<?= $value->id ?>'><?php echo $value->trimestre_ii; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea readonly="" rows='10' style="height: 38px;width: 120px;" class=" form-control capturar numeric" id='trimestre_iii_<?= $value->id ?>' name='<?= $value->id ?>'><?php echo $value->trimestre_iii; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea readonly="" rows='10' style="height: 38px;width: 120px;" class=" form-control capturar numeric" id='trimestre_iv_<?= $value->id ?>' name='<?= $value->id ?>'><?php echo $value->trimestre_iv; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea readonly="" rows='10' readonly="" style="height: 38px;width: 120px;color: red;" class=" form-control capturar" id='total_<?= $value->id ?>' name='<?= $value->id ?>'><?php echo $value->total; ?></textarea>
                                    </td>
                                    <td><img id='<?php echo $value->id; ?>' title="Editar Acción..." class="editar_accion" style="width:25px;height: 25px;cursor:pointer;" src="<?php echo base_url("assets/image/editar.png"); ?>"/></td>
                                </tr>
                                <?php
                                $i = $i + 1;
                            }
                            ...
                            foreach ($dist_tri_acc as $value) {
                                ...
                                <tr style="font-size: 16px;font-size: 14px;" id="tr_<?php echo $value->id_acc; ?>">
                                    ...
                                    <td style='width: 5% !important;'>
                                        <textarea style="height: 38px;text-transform:uppercase" class="form-control capturar numeric" id='I_<?= $value->id_acc ?>' name='<?= $value->id_acc ?>' onblur="javascript:this.value = this.value.toUpperCase();"><?php echo $value->trimestre_i; ?></textarea>
                                    </td>
                                    <td style='width: 5% !important;'>
                                        <textarea style="height: 38px;text-transform:uppercase" class="form-control capturar numeric" id='II_<?= $value->id_acc ?>' name='<?= $value->id_acc ?>' onblur="javascript:this.value = this.value.toUpperCase();"><?php echo $value->trimestre_ii; ?></textarea>
                                    </td>
                                    <td style='width: 5% !important;'>
                                        <textarea style="height: 38px;width: 120px;" class="form-control capturar numeric" id='III_<?= $value->id_acc ?>' name='<?= $value->id_acc ?>'><?php echo $value->trimestre_iii; ?></textarea>
                                    </td>
                                    <td style='width: 5% !important;'>
                                        <textarea style="height: 38px;width: 120px;" class=" form-control capturar numeric" id='IV_<?= $value->id_acc ?>' name='<?= $value->id_acc ?>'><?php echo $value->trimestre_iv; ?></textarea>
                                    </td>
                                    <td style='width: 5% !important;'>
                                        <textarea readonly='' style="height: 38px;width: 120px;color: red;" class=" form-control capturar" id='cantidad_<?= $value->id_acc ?>' name='<?= $value->id_acc ?>'><?php echo $value->total; ?></textarea>
                                    </td>
                                </tr>
                                <?php
                                $i = $i + 1;
                        ...
                        <tbody style="background-color: #FFFFFF;">
                            ...
                            foreach ($distribucion_imp as $value) {
                                ...
                                <tr style="font-size: 16px;font-size: 14px;" id="tr_<?php echo $value->id; ?>">
                                    ...
                                    <td>
                                        <textarea style="height: 38px;" class="form-control capturar" id='IP_<?= $value->id ?>' name='<?= $value->id ?>'><?php echo $value->trimestre_i; ?></textarea>
                                    </td>
                                    <td>
                                        <textarea style="height: 38px;" class="form-control capturar" id='IIP_<?= $value->id ?>' name='<?= $value->id ?>'><?php echo $value->trimestre_ii; ?></textarea>
                                    </td>
                                    <td>
        ...
        <div class="row" style="text-align: center">
            <a href="<?php echo base_url('acciones/proyecto/ControllersProyecto'); ?>">
...
<form id='form_acciones_especificas' action="" method="POST" style='display: none;'>
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-xs-1" >Trimestre(s)</div>

            <div style="float: left;">
                <input maxlength="10" id="trimestre_i" style="width: 52%;float:right;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" name="trimestre_i" type="text" class="form-control" placeholder="I" />
            </div>
            <div style="float: left;margin-left: -7%;">
                <input maxlength="10" id="trimestre_ii" style="width: 52%;float:right;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" name="trimestre_ii" type="text" class="form-control" placeholder="II"/>
            </div>
            <div style="float: left;margin-left: -7%">
                <input maxlength="10" id="trimestre_iii" style="width: 52%;float:right;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" name="trimestre_iii" type="text" class="form-control" placeholder="III"/>
            </div>
            <div style="float: left;margin-left: -7%">
                <input maxlength="10" id="trimestre_iv" style="width: 52%;float:right;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" name="trimestre_iv" type="text" class="form-control" placeholder="IV"/>
            </div>
            <div style="float: left;margin-left: -5%;">
                <input maxlength="10" id="total" style="width: 52%;float:right;" name="total" type="text" class="form-control" placeholder="Total" readonly="" />
            </div>
        </div>
        <br/>
        <div class="row" style="text-align: center">
