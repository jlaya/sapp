    ...
    $(document).ready(function () {
        ...
        $("#registrar").click(function (e) {
            ...
            if ($('#plan_patria').val().trim() == '') {
                ...
                $.post('<?php echo base_url(); ?>objetivo_general/ControllersObjG/guardar', $('#form_obj_general').serialize(), function (response) {
    ...
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default">
        <div class="panel-heading" style='background: linear-gradient(#2F9292, #3B7272);color:#FFFFFF;' >
            <label style="float: left" class="panel-title " ><a  href="<?php echo base_url(); ?>objetivo_general/ControllersObjG" >Configuraciones</a>
                > Registrar Objetivo General</label>
            <br>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-7">
                <textarea class="form-control" id="objetivo_general" name="objetivo_general" rows="4" cols="50" style="width: 130%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();"></textarea> 
            </div>
        </div>
        <br/>
