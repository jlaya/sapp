    ...
    <?php
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="form-group col-xs-4">
                    <label >Usuario</label>
                    <input type="text" id="si_user" name="si_user" data-validate='required|max(20)|min(3)' data-type="alphanumeric" data-text="lower" data-add="id"  class="form-control input-sm" value="">
                </div>
                <div class="form-group col-xs-4">
                    <label >Nombre</label>
                    <input type="text" id="first_name" name="first_name" data-validate='required|max(20)|min(3)' data-type="alphaspace" data-text="capitalize" data-add="id" class="form-control input-sm" value="">
                </div>
                <div class="form-group col-xs-4">
                    <label >Apellido</label>
                    <input type="text" id="last_name" name="last_name" data-validate='required|max(20)|min(3)' data-type="alphaspace" data-text="capitalize" data-add="id" class="form-control input-sm" value="">
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-xs-4 col-xs-push-4" style="text-align: center">
                <input type="button" class="btn btn-primary" data-accion="guardar" data-method="guardar" id="guardar" name="guardar" value="Guardar" />
