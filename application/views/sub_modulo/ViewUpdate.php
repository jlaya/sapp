...
<script>
    $(document).ready(function () {
        $("select").select2();
        $("#id_modulo").select2('val',$("#id_mod").val());
...
<form id='form_sub_modulo' action="" method="POST">
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default">
        <div class="panel-heading" style='background: linear-gradient(#2F9292, #3B7272);color:#FFFFFF;' >
            <label style="float: left" class="panel-title "><a  href="<?php echo base_url();?>sub_modulo/ControllersSubModulo">Configuraciones > Configuración</a>
                > Modificar Sub Módulo</label>
            <br>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-10">
                <input id="sub_modulo" value="<?php echo $detalles_lista->sub_modulo ?>" style="width: 100%;" placeholder="Ingrese el nombre del módulo" name="sub_modulo" type="text" class="form-control" />
            </div>
        </div>
        <div class="panel-body">
            <div class="col-xs-2" >Url</div>
            <div class="col-xs-10">
                <input id="url" value="<?php echo $detalles_lista->url ?>" style="width: 100%;"  placeholder="Ingrese la url" name="url" type="text" class="form-control" />
            </div>
        </div>
        <div class="panel-body">
            <div class="col-xs-2" >Posición</div>
            <div class="col-xs-6">
                <input id="posicion" value="<?php echo $detalles_lista->posicion ?>" style="width: 20%;" placeholder="Posición" name="posicion" type="text" class="form-control" />
            </div>
            <div class="col-xs-2" style='margin-left: -35%'>
                <label>Activo&nbsp;&nbsp;</label>
                <input id="activo" name="activo" type='checkbox'
                <?php if($detalles_lista->activo == 't'){
                  ?>
                  checked='checked'
                 <?php }?>/>
            </div>
        ...
        <div class="row" style="text-align: center">
            ...
            <input type="hidden" id="id_mod" value="<?php echo $detalles_lista->id_modulo ?>" />
        </div>
        <br/>
    </div>
</form>
