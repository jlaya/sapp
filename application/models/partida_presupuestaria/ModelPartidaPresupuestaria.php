 ...
 * @author jesus
 */
class ModelPartidaPresupuestaria extends CI_Model
{
    ...
    {
        $result = $this->db->where('partida_presupuestaria =', $datos['partida_presupuestaria']);
        $result = $this->db->or_where('codigo = ', $datos['codigo']);
        $result = $this->db->get('partida_presupuestaria');

        if ($result->num_rows() > 0) {
            #echo "CORRECTO";
            echo '1';
        } else {
            $result = $this->db->insert("partida_presupuestaria", $datos);
            return $result;
        }
    }
    ...
    public function actualizar($datos)
    {
        ...
        $result = $this->db->update('partida_presupuestaria', $datos);
        return $result;
    }
    ...
    public function eliminar($id)
    {
        ...
        if ($result->num_rows() > 0) {
            ...
            $result = $this->db->delete('partida_presupuestaria');
            return $result;
        /*}*/
    }
