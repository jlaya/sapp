            ...
            bootbox.dialog({
                ...
                buttons: {
                    ...
                    danger: {
                        ...
                        callback: function () {
                            //alert(id)
                            $.post('<?php echo base_url(); ?>plan_patria/ControllersPlanPatria/delete/' + id + '', function (response) {
            ...
            <tbody>
                ...
                foreach ($lista_plan_patria as $value) {
                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td>
                            <a href="<?php echo base_url('plan_patria/ControllersPlanPatria/procesar/' . $value->id. "?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                                <?php echo $value->plan_patria; ?>
                            </a>
                        </td> 
                        <td style='text-align: center'>
                            <a href="<?php echo base_url('plan_patria/ControllersPlanPatria/procesar/' . $value->id); ?>">
