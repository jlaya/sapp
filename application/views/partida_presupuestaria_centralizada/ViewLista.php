            ...
            <tbody>
                ...
                foreach ($lista_partida_presupuestaria_centralizada as $value) {
                    ...
                    <tr style="font-size: 16px">
                        ...
                        <td><a href="<?php echo base_url('partida_presupuestaria_centralizada/ControllersPartidaPresupuestariaCentralizada/procesar/' . $value->id. "?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                            <?php
