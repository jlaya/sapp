...
<script>
    $(document).ready(function () {
        ...
        $("#tipo_ins").select2('val', parseInt($("#id_tipo_ins").val()));
        $("#sector").select2('val', parseInt($("#id_sector").val()));
        $("#tipo_estructura").select2('val', parseInt($("#id_tipo_estructura").val()));
        ...
        $("#registrar").click(function (e) {
            ...
            if ($('#nombre_ins').val().trim() == '') {
                ...
                $.post('<?php echo base_url(); ?>entes/ControllersEntes/update', $('#form_organos').serialize(), function (response) {

                    if (response == '1') {

                        bootbox.alert("Disculpe, ya existe una institución con este nombre registrado, verifique los datos ", function () {
                        }).on('hidden.bs.modal', function (event) {
                            $("#nombre_ins").parent('div').addClass('has-error');
                            $("#nombre_ins").focus();
                        });
    ...
    <div style="width: 95%;text-transform:uppercase;box-shadow: 0 1px 5px rgba(0,0,0,.85);margin: auto;" class="panel panel-default">
        <div class="panel-heading" style='background: linear-gradient(#2F9292, #3B7272);color:#FFFFFF;' >
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-4">
                    <input maxlength="300" autofocus="autofocus" id="nombre_ins" value="<?php echo $data->nom_ins ?>" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese la institución" name="nom_ins" type="text" class="form-control" />
                </div>

                <div class="col-xs-2">
                    <input maxlength="10" id="siglas" value="<?php echo $data->siglas ?>" style="width: 70%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Siglas" name="siglas" type="text" class="form-control" />
                </div>
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-4">
                    <input maxlength="300" id="nom_resp" value="<?php echo $data->nom_resp ?>" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese nombre del responsable" name="nom_resp" type="text" class="form-control" />
                </div>

                <div class="col-xs-2">
                    <input maxlength="9" id="cedula" value="<?php echo $data->cedula ?>" style="width: 70%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Cédula" name="cedula" type="text" class="form-control" />
                </div>
                <div class="col-xs-1" style="margin-left: -5%">Teléfono</div>
                <div class="col-xs-4" style="margin-left: 5%">
                    <input id="telefono" value="<?php echo $data->tlf ?>" style="width: 90%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ejemplo: 0426-1234567/0243-12345678" name="tlf" type="text" class="form-control" />
                </div>
            </div>
            <div class="panel-body">
                <div class="col-xs-1">Cargo</div>
                <div class="col-xs-4">
                    <input maxlength="50" id="nom_cargo" value="<?php echo $data->cargo ?>" style="width: 100%;text-transform:uppercase;" onblur="javascript:this.value = this.value.toUpperCase();" placeholder="Ingrese el nom_cargo" name="cargo" type="text" class="form-control" />
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-4">
                        <input maxlength="300" id="email" value="<?php echo $data->correo ?>" style="width: 100%;" placeholder="Ingrese el email" name="correo" type="text" class="form-control" />
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-xs-11">
                            <textarea onblur="javascript:this.value = this.value.toUpperCase();" style="width:97%;text-transform: uppercase;" id="direccion_hab" name="direccion" rows="3" cols="50" class="form-control"><?php echo $data->direccion ?></textarea>
                        </div>
                    </div>
                    <br/>
                    ...
                    <?php } ?>
                    <input id="id_tipo_ins" type="hidden" value="<?php echo $data->tipo_ins ?>"/>
                    <input id="id_sector" type="hidden" value="<?php echo $data->sector ?>"/>
                    <input id="id_tipo_estructura" type="hidden" value="<?php echo $data->tipo_estructura ?>"/>
