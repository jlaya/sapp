                        ...
                        danger: {
                            ...
                            $.post('<?php echo base_url(); ?>acciones/observaciones/ControllersObservacionesProy/modificar', $('#form_observacion_acciones').serialize(), function (response) {
                                bootbox.alert("Se actualizo con exito", function () {
                                    ...
                                    url = "<?php echo base_url(); ?>acciones/observaciones/ControllersObservacionesProy/procesar/<?php echo $detalles_lista->id_accion ?>"
                                    window.location = url;
                                });
                            });
...
$("table#tabla_fuente_financiamiento_modificado").on('change', 'textarea.capturar', function (e) {
    ...
    $("table#tabla_fuente_financiamiento_modificado tr#tr_" + id + "").css("background-color", "#D5F2F1");
            ...
            $.post('<?php echo base_url(); ?>acciones/observaciones/ControllersObservacionesProy/monto_modificado', data , function (response) {
...
$("#add-mount-poa").click(function (e) {
    ...
    if ($('#partida_id').val().trim() == '') {
        ...
        $.post('<?php echo base_url(); ?>acciones/observaciones/ControllersObservacionesProy/monto_modificado', $('#frm-add-monto').serialize(), function (response) {
        ...
        <div class="panel-heading" style='background: linear-gradient(#2F9292, #3B7272);color:#FFFFFF;'>
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-8">
                    ...
                    <select id='id_accion' style='width: 11.5%;' disabled="">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-xs-10">
                            <div style="float: left;">
                                <input placeholder="00-00-00-00" value="<?php echo $detalles_lista->estructura; ?>" type="text" id="estructura" name="estructura" placeholder="00-00-00-00" class="estructura form-control" style='width: 90%;'/>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
...
<input type="hidden" id="accion" name="id_accion" value="<?php echo $detalles_lista->id_accion ?>"/>
