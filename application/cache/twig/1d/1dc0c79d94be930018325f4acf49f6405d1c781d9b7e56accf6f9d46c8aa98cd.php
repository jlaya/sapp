...
/* gestion/pdf/proyecto/III.twig */
class __TwigTemplate_a3e886a02e9ee6fa8d196c8f2fed80308486c89c8ae6e95782872b64b9d7ab78 extends Twig_Template
{
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            // line 84
            echo "\t\t\t<tr>
\t\t\t\t<td style=\"width: 20%;height: 50px !important;\" class=\"text-left\">";
            // line 85
            echo twig_escape_filter($this->env, $this->getAttribute($context["row"], "acc_esp", array()), "html", null, true);
            echo "</td>
\t\t\t\t<td class=\"text-left\">";
            // line 86
...
\t\t\t\t<td>";
            // line 88
            echo twig_escape_filter($this->env, $this->getAttribute($context["row"], "trimestre_iii", array()), "html", null, true);
            echo "</td>
\t\t\t\t<td>";
            // line 89
            echo twig_escape_filter($this->env, $this->getAttribute($context["row"], "iii", array()), "html", null, true);
            echo "</td>
\t\t\t\t<td>";
            // line 90
...
\t</table>
    ...
    {
        return "gestion/pdf/proyecto/III.twig";
    }
    ...
    {
        return array (  228 => 126,  223 => 123,  217 => 122,  215 => 121,  209 => 118,  205 => 117,  201 => 116,  197 => 115,  194 => 114,  189 => 113,  187 => 112,  167 => 95,  163 => 93,  154 => 90,  150 => 89,  146 => 88,  142 => 87,  138 => 86,  134 => 85,  131 => 84,  127 => 83,  106 => 65,  92 => 54,  87 => 52,  80 => 48,  58 => 29,  49 => 23,  28 => 5,  24 => 4,  19 => 1,);
    }
...
\t\t{% for row in act_acc %}
\t\t\t<tr>
\t\t\t\t<td style=\"width: 20%;height: 50px !important;\" class=\"text-left\">{{ row.acc_esp }}</td>
\t\t\t\t<td class=\"text-left\">{{ row.unidad_medida }}</td>
\t\t\t\t<td class=\"text-left\">{{ row.medio_verificacion }}</td>
\t\t\t\t<td>{{ row.trimestre_iii }}</td>
\t\t\t\t<td>{{ row.iii }}</td>
...
</html>", "gestion/pdf/proyecto/III.twig", "/var/www/html/sapp/application/views/gestion/pdf/proyecto/III.twig");
    }
}
