...
<script>
    $(document).ready(function () {
        ...
        var TSectores = $('#tab_sectores').dataTable({
            "iDisplayLength": 10,
            "iDisplayStart": 0,
        ...
        $("table#tab_sectores").on('click', 'img.borrar', function (e) {
            e.preventDefault();
...
<div class="row-fluid" >
    <div class="container mainbody-section text-center"  style="width:100%;">
        <a href="<?php echo base_url('sectores/ControllersSectores/nuevo'); ?>">
        ...
        <table style="width:100%;" border="0" align="center" cellspacing="1" id="tab_sectores" align="center"
            ...
            <thead style="font-size: 16px">
                <tr style="background-color: #263238">
                    <th style='text-align: center;color: white' colspan="15">Listado de Sectores</th>
                </tr>
            ...
            <tbody>
                ...
                <?php
                $i= 1;
                foreach ($lista_sectores as $value) {
                    ?>
                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td>
                            <a href="<?php echo base_url('sectores/ControllersSectores/procesar/' . $value->id. "?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                                <?php echo $value->sector; ?>
                            </a>
                        </td> 
                        <td style='text-align: center'>
                            <a href="<?php echo base_url('sectores/ControllersSectores/procesar/' . $value->id); ?>">
