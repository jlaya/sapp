...
<script>
    $(document).ready(function () {
        ...
        var TSectores = $('#tab_accion_centralizada').dataTable({
            "iDisplayLength": 10,
            "iDisplayStart": 0,
        ...
        $("table#tab_accion_centralizada").on('click', 'img.borrar', function (e) {
            e.preventDefault();
            ...
            bootbox.dialog({
                ...
                buttons: {
                    ...
                    danger: {
                        ...
                        callback: function () {
                            //alert(id)
                            $.post('<?php echo base_url(); ?>accion_centralizada/ControllersAccionCentralizada/delete/' + id + '', function (response) {
...
<div class="row-fluid" >
    <div class="container mainbody-section text-center"  style="width:100%;">
        <a href="<?php echo base_url('accion_centralizada/ControllersAccionCentralizada/nuevo'); ?>">
            <button role="button" class="btn btn-default" style="font-weight: bold;font-size: 13px" id="enviar" >
                &nbsp;<span class="glyphicon glyphicon-plus"></span>&nbsp;
                Agregar Acción Centralizada
            </button>
        </a>
        </br>
        </br>
        <table style="width:100%;" border="0" align="center" cellspacing="1" id="tab_accion_centralizada" align="center"
            ...
            <thead style="font-size: 16px">
                <tr style="background-color: #263238">
                    <th style='text-align: center;color: white' colspan="15">Listado de Acciones Centralizadas</th>
                </tr>
            ...
            <tbody>
                ...
                foreach ($lista_accion_centralizada as $value) {
                    ...
                    <tr style="font-size: 16px" class="{% cycle 'impar' 'par' %}">
                        ...
                        <td>
                            <a href="<?php echo base_url('accion_centralizada/ControllersAccionCentralizada/procesar/' . $value->id. "?ver=1"); ?>" style="cursor: pointer;text-decoration: none;" title="Ver Información preliminar">
                                <?php echo $value->accion_centralizada; ?>
                            </a>
                        </td> 
                        <td style='text-align: center'>
                            <a href="<?php echo base_url('accion_centralizada/ControllersAccionCentralizada/procesar/' . $value->id); ?>">
