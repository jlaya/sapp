...
$(document).ready(function () {
    ...
    $('.table-gestion-acc tbody').on('click', 'tr.row-detail', function () {
        ...
        var I          = $(this).attr("data-trimestre_i");
        var II         = $(this).attr("data-trimestre_ii");
        var III        = $(this).attr("data-trimestre_iii");
        var IV         = $(this).attr("data-trimestre_iv");
        ...
        $("#porcentaje").val(por);
        $("span.trimestre_I").text(I);
        $("span.trimestre_II").text(II);
        $("span.trimestre_III").text(III);
        $("span.trimestre_IV").text(IV);
    });
    ...
    $('span.send-acc-ej').on('click', function (e) {
        e.preventDefault();
    ...
    $("#proyecto_id").change(function (event) {
        var value = $(this).val();
        var url = base_url("/gestion/proy/" + value);
        if (value > 0) {
            window.location = url;
        }
    });
